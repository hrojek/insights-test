...
################################################################################
package_name = os.getenv("INSIGHTS_PACKAGE_NAME", "insights")
...
include_packages = list(
    chain.from_iterable(map(lambda name: [name, f"{name}.*"], ["insights"]))
)
...
setup(
    name=package_name,
    url="https://github.com/hrojek/insights-test",
    version=version,
    author="Hernan Rojek Moriceau",
    author_email="test@test.com",
    description="Testing GitHub Insights functionality",
